...
import xyz.tachung.vele.dto.ArticleForm;
import xyz.tachung.vele.entity.Article;
import xyz.tachung.vele.repository.ArticleRepository;

import java.util.List;

@Controller
@Slf4j  // Simple Logging Facade for Java -> 로깅하는 어노테이션
public class ArticleController {
    ...
    public String createArticle(ArticleForm form) {
        ...
        // System.out.println(form.toString()); -> 로깅기능으로 대체해야 됨 실무에선 쓰지 않음
